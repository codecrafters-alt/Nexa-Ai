...
function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <img
        onClick={() => navigate("/")}
        src={theme === "dark" ? assets.logo_full1 : assets.logo_full_dark1}
        alt=""
        ...
        {chats
          ...
          .map((chat) => (
            <div
              ...
              className={`p-2 px-4 border rounded-md cursor-pointer flex justify-between group
    ${
      ...
      >
        ...
        <div className="flex flex-col text-sm">
          ...
          <p className="text-xs text-gray-400">
            Purchase credits to use Nexa AI
          </p>
        </div>
      </div>
