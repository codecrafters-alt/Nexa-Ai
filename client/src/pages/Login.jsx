  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="bg-purple-700 hover:bg-purple-800 transition-all text-white w-full py-2 rounded-md cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
      >
        {loading
          ? "Processing..."
          : state === "register"
